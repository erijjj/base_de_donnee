-- ============================================================
--  SCRIPT 2 : PEUPLEMENT DE LA BASE
--  À exécuter APRÈS 01_createschema.sql
-- ============================================================
...
-- Vérification
SELECT 'classroom'  AS table_name, COUNT(*) AS nb FROM classroom  UNION ALL
...
SELECT 'takes',      COUNT(*) FROM takes      UNION ALL
SELECT 'advisor',    COUNT(*) FROM advisor    UNION ALL
SELECT 'time_slot',  COUNT(*) FROM time_slot  UNION ALL
SELECT 'prereq',     COUNT(*) FROM prereq;
